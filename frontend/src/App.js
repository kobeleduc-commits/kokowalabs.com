...
import RoasteryProfitCompass from "@/pages/RoasteryProfitCompass";
    ...
    <div className="App">
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/roastery-profit-compass" element={<MarketingShell><RoasteryProfitCompass /></MarketingShell>} />
